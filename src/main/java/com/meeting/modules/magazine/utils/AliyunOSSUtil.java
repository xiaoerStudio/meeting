package com.meeting.modules.magazine.utils;
...
import com.meeting.modules.magazine.config.OssConstantConfig;
...
public class AliyunOSSUtil {
    ...
    private final OssConstantConfig constantConfig;

    Logger logger = LoggerFactory.getLogger(this.getClass());

    @Autowired
    public AliyunOSSUtil(OssConstantConfig constantConfig) {

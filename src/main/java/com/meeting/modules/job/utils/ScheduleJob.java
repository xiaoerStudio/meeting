package com.meeting.modules.job.utils;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		...
		Gson gs = new Gson();
		String scheduleJobStr = gs.toJson(scheduleJobObj);

		ScheduleJobEntity scheduleJob = gs.fromJson(scheduleJobStr, ScheduleJobEntity.class);
		// 获取spring bean
